...
from amf_api.amf.src.argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam1_features_map import Dam1ArgumentRelationAnalyzer
from src.argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam2_features_map import Dam2ArgumentRelationAnalyzer
from src.argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam3_features_map import Dam3ArgumentRelationAnalyzer
"""

from xaif_eval import xaif
from argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam1_features_map import Dam1ArgumentRelationAnalyzer
from argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam2_features_map import Dam2ArgumentRelationAnalyzer
from argument_mining_framework.modules.dam.ArgumentRelationAnalyser.dam3_features_map import Dam3ArgumentRelationAnalyzer

print("----------------------------------------------")
class Predictor:
    def __init__(self,dam_verssion,variant=None):
        if dam_verssion == "1":
